...
1. **Opening & Welcome** (5 min) — President or Toastmaster of the Day opens
2. **Table Topics** (15 min) — Impromptu speaking: random questions, 1-2 minute responses
3. **Prepared Speeches** (20-30 min) — 2-3 members deliver planned speeches (from Pathways program)
4. **Evaluations** (15 min) — Experienced members give constructive feedback on speeches
5. **General Evaluator Report** (5 min) — Overall meeting feedback
6. **Awards & Closing** (5 min) — Best Speaker, Best Evaluator, Best Table Topics
